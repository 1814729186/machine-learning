...
class Face_Recognizer:
    ...
    def draw_note(self, img_rd):
        ...
        #putText方法，参数：img_rd,显示内容，显示位置（坐标），字体，大小，颜色（RGB）...
        #cv2.putText(img_rd, "Q: Quit", (10, 450), font, 0.3, (255, 255, 255), 1, cv2.LINE_AA)
    ...
    def modify_name_camera_list(self):
        ...
        self.name_known_list[0] ='Jack Ma'.encode('utf-8').decode()
        self.name_known_list[1] ='Ma Huateng'.encode('utf-8').decode()
        self.name_known_list[2] ='Ren Zhengfei'.encode('utf-8').decode()
        self.name_known_list[3] ='MaZhongping'.encode('utf-8').decode()
...
def main():
    strSeclect = input("1 实时人脸识别. 2 数据库人脸识别\n")
